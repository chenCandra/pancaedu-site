...
soal:
  - tipe: pilihan-ganda
    ...
    pilihan:
      - { id: a, teks: "Kenaikan suhu rata-rata permukaan bumi secara terus-menerus dalam jangka panjang" }
      - { id: b, teks: "Cuaca panas yang terjadi satu-dua hari di musim kemarau" }
      - { id: c, teks: "Suhu matahari yang semakin panas dari waktu ke waktu" }
      - { id: d, teks: "Efek rumah kaca yang seharusnya dihilangkan sama sekali" }
    jawabanBenarId: a
